export interface HealthCondition {
	id: string;
	label: string;
	icon: string; // SVG path(s) for a 24x24 viewBox, stroke only, no fill
}
...
export const healthConditionOptions: HealthCondition[] = [
	...
	},
	{
		...
		// glass with line through
		icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 2h8l-1 10H9L8 2zm-1 14h10M12 12v4m-4 4h8"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 5l-3 3m0-3l3 3"/>'
	},
	{
		id: 'glutenunvertraeglichkeit',
		label: 'Glutenunverträglichkeit / Zöliakie',
		// wheat with slash
		icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m-3-12c1.5 0 3 1 3 3m0-3c1.5 0 3 1 3 3m-6 2c1.5 0 3 1 3 3m0-3c1.5 0 3 1 3 3"/><path stroke-linecap="round" stroke-width="2" d="M4 4l16 16"/>'
	},
	{
		id: 'fruktoseintoleranz',
		label: 'Fruktoseintoleranz',
		// apple
		icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3c-1-1-3-1-4 0S6 6 6 9c0 5 3 9 6 12 3-3 6-7 6-12 0-3-1-5-2-6s-3-1-4 0zm-2-1c1-1 2-1 2-1"/>'
	},
	{
	...
	},
	{
		id: 'nussallergie',
		label: 'Nussallergie',
		// nut shape with cross
		icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3C7.58 3 4 6.58 4 11c0 4 3 7 8 10 5-3 8-6 8-10 0-4.42-3.58-8-8-8z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v5m-2-2.5h4"/>'
	},
	{
		id: 'sojaallergie',
		label: 'Sojaallergie',
		// bean shape with line
		icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.5 5.5c2 2 2 6-1 9s-7 3-9 1-2-6 1-9 7-3 9-1z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 10l4 4"/>'
	},
	{
		id: 'fischallergie',
		label: 'Fisch-/Meeresfrüchte-Allergie',
		// fish
		icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 12c0 3-4 6-8 6s-6-2-7-3l2-3-2-3c1-1 3-3 7-3s8 3 8 6z"/><circle cx="15" cy="11" r="1" stroke-width="2"/>'
	},
	{
		id: 'eiallergie',
		label: 'Eiallergie',
	...
	},
	{
		...
		// stomach
		icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3c3 0 5 2 5 5 0 2-1 3-2 4s-2 3-2 5v4m0-14c-3 0-5 2-5 5 0 2 1 3 2 4"/><circle cx="12" cy="20" r="1" stroke-width="2"/>'
	},
	{
		id: 'cholesterin',
	...
	},
	{
		...
		// person silhouette
		icon: '<circle cx="12" cy="5" r="3" stroke-width="2"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-4 0-6 3-6 7h12c0-4-2-7-6-7z"/><circle cx="12" cy="14" r="2" stroke-width="2"/>'
	}
];
